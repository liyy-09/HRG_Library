...
- (void)startSelectPhotoWithImageName:(NSString *)imageName {
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:imageName message:nil preferredStyle: UIAlertControllerStyleActionSheet];
...
-(void)selectPhotoWithType:(int)type {
    if (type == 2) {
        ...
        UIImagePickerController *ipVC = [[UIImagePickerController alloc] init];
        ipVC.modalTransitionStyle = UIModalTransitionStyleCoverVertical;// 设置跳转方式
        ipVC.delegate = self;
